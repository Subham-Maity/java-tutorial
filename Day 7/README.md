# 32 Questions Ultimate Practice Set Made By Subham for Given Notes ( For || While || Do While)


# Beginner Question 


#### 1. Write a for loop that iterates through the numbers 0 through 20 and print it.
#### 2. Multiplication table for numbers 0 through 10
#### 3. Reverse Multiplication table for numbers 0 through 10
#### 4. User enter a number and the program will print the multiplication table for that number  
#### 5. Write a program to find the factorial value of any number entered through the keyboard.
#### 6. Write a program to find the sum of the first n natural numbers.
...
# 21. Break in For and Do While Loop 1
...
# 22. Continue in For and Do While Loop 1
...
# 23. Sum first n even numbers using a while loop
...
# 25. Calculate the sum of the numbers occurring in the multiplication table
